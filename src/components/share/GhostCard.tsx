...
export function generateCardSVG(data: GhostCardData): string {
  ...
  return `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 800" style="font-family: system-ui, sans-serif;">
      ...
      <text x="165" y="245" text-anchor="middle" font-size="14" fill="#FF7F6E" font-weight="600">PAIN POINT</text>
      ...
      <text x="435" y="245" text-anchor="middle" font-size="14" fill="#C3AFFF" font-weight="600">OBSESSION</text>
      ...
      <text x="300" y="430" text-anchor="middle" font-size="20" font-weight="bold" fill="white">PERFECT GIFT</text>
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: `Gift for ${data.persona}`,
          text: `I found the perfect gift: ${data.gift.item}!`,
    ...
    <div className={styles.cardContainer}>
      ...
      >
        ...
        <div className={styles.header}>
          <span className={styles.logo}>🎁 GiftGhost</span>
        </div>
        ...
        <div className={styles.insightsGrid}>
          <div className={styles.insightCard}>
            <div className={styles.insightHeader}>
              ...
              <span className={styles.insightLabel}>Pain Point</span>
            </div>
          ...
          <div className={styles.insightCard}>
            <div className={styles.insightHeader}>
              <span className={styles.insightIcon}>💎</span>
              <span className={styles.insightLabel}>Obsession</span>
            </div>
        ...
        <div className={styles.giftHero}>
          ...
          {data.gift.priceRange && (
            <p className={styles.priceRange}>💰 {data.gift.priceRange}</p>
          )}
        </div>

        {/* Footer */}
        <div className={styles.footer}>
          <span>Generated by GiftGhost</span>
        </div>
      </motion.div>
